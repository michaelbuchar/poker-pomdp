...
def calc_full_state_before_player():
    full_state_before = State_Generation_Methods.generate_state(player_hole_cards, opponent_hole_cards, board_cards,hole_card_probability_file)
...
def calc_full_state_before_opponent():
    full_state_before_opponent = State_Generation_Methods.generate_state(opponent_hole_cards, player_hole_cards, board_cards,hole_card_probability_file)
...
def play_phase(phase, player_hole_cards, opponent_hole_cards, opponent_bankroll, player_bankroll, pot, board_cards,hole_card_probability_file):
    #main script for playing a turn of poker
    policy_file = "BetterPolicy.policy"
    ...
    if player_goes_first:
        ...
        policy_action = get_action_kde(policy_states, policy_actions, full_state_before_opponent)
        opponent_bankroll, pot, effective_opponent_action, opponent_bet, raise_count = Action_Function.handle_action(
            ...
            is_river=(phase == "River"),
            raise_count=raise_count,
            policy_action=policy_action,  # Opponent does not use policy
        )
...
if __name__ == "__main__":
    ...
    for game in range(1, num_games + 1):
        ...
        while player_bankroll > 0.5 and opponent_bankroll > 0.5: # make sure there is at least 1 chip able to be played
            ...
            csv_file = "POMDP_training_data4.csv"  # Output CSV file
            ...
            for phase in ["Hole Cards", "Flop", "Turn", "River"]:
                player_bankroll, opponent_bankroll, pot, game_ended = play_phase(phase, player_hole_cards, opponent_hole_cards, opponent_bankroll, player_bankroll, pot, board_cards,hole_card_probability_file)
